...
fig1.suptitle('Figure 5: Comparison of $\omega$ contours, Δx = Δy = L/100, $x_s$ = L/4, t = (L/4)/S',fontsize=10)
...
fig2.suptitle('Figure 6: Comparison of $\omega$ profiles at $y/L = 1/2$, $x_s$ = L/4, t = (L/4)/S',fontsize=10)
...
fig3.suptitle('Figure 8: Time history of $\epsilon$, $x_s$ = L/4, t = (L/4)/S',fontsize=10)
...
fig4.suptitle('Figure 9: Time history of $\dot S_{dil}$, $x_s$ = L/4, t = (L/4)/S',fontsize=10)
...
fig5.suptitle('Figure 10: Time history of $\dot S_{tor}$, $x_s$ = L/4, t = (L/4)/S',fontsize=10)
...
fig6.suptitle('Figure 11: Comparison of $\dot S_{dil}$ contours, Δx = Δy = L/100, $x_s$ = L/4, t = (L/4)/S',fontsize=10)
ax1[0].set_title('MacCormack method',fontsize=10)
...
fig7.suptitle('Figure 12: Comparison of $\dot S_{tor}$ contours, Δx = Δy = L/100, $x_s$ = L/4, t = (L/4)/S',fontsize=10)
ax1[0].set_title('MacCormack method',fontsize=10)
